...
export const BannerSection = () => {
    return (
        <section className=" min-h-[33.75rem] flex flex-col md:flex-row items-center justify-around px-[5%] gap-[3.75rem]">
            <div className="w-full md:w-1/2 flex flex-col gap-5 mt-10">
                ...
                <Link className="flex justify-center items-center max-w-[21.625rem] max-h-[3.875rem] rounded-[0.625rem] bg-[linear-gradient(259.18deg,_#E8924A_6.97%,_#E97B19_34.07%,_#E97B19_68.27%,_#F6B049_94.23%)] py-[14px] hover:opacity-90 cursor-pointer gap-4 pl-[2rem] pr-[2.375rem] m-auto md:m-0" to="">
