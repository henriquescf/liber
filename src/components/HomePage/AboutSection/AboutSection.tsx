...
export const AboutSection = () => {
    return(
        <section className="flex flex-col items-center mt-[0] md:mt-[-6.25rem]">
            ...
            <div className="flex flex-col items-center gap-[2.875rem] text-center w-[80%] md:w-[70%]">
                <h2 className="text-[1.75rem] md:text-[3.125rem]">Sobre a <span className="border-b-[0.5rem] border-b-[rgba(246,_136,_42,_1)]">Liber</span></h2>
