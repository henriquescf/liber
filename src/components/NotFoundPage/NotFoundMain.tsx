...
export const NotFoundMain = () => {
    return (
        <main className="relative">
            <img src="/src/assets/img/notfoundpage/notfound1.png" alt="vector-1" className="absolute hidden md:block md:h-[12.875rem] md:w-[13.125rem] md:right-0"/>
            <img src="/src/assets/img/notfoundpage/notfound2.png" alt="vector-2" className=" absolute hidden md:block md:h-[20rem] md:w-[12.5rem] md:left-0 md:top-[30%]"/>
            <img src="/src/assets/img/notfoundpage/notfound3.png" alt="vector-3" className="absolute bottom-0 right-8 h-[4.5rem] w-[8.75rem] md:h-[10rem] md:w-[18.75rem] md:right-[8.75rem]"/>
            <img src="/src/assets/img/notfoundpage/notfound4.png" alt="vector-4" className="absolute block top-0 left-0 h-[6rem] md:hidden"/>
            ...
            <div className="flex flex-col mx-auto w-[100%] md:w-[45%] mt-[6.625rem] md:mt-[4.625rem] items-center gap-[2.875rem] md:gap-[5.25rem] relative mb-[7.5rem]">
                ...
                <img src="/src/assets/img/notfoundpage/error404.png" className="h-[117px] w-[207px] min-h-[117px] min-w-[207px] md:w-auto md:h-auto"/>
