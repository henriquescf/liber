        ...
        <footer className="min-h-[33.875rem] bg-[#090028]">
            <div className="w-[90%] md:w-[80%] flex flex-col mx-auto *:text-white gap-[3.75rem]">
                <div className="flex justify-between flex-col md:flex-row items-center mt-[3.75rem] gap-[3.125rem]">
                    <img src="/src/assets/img/Footer/footer-logo.png" alt="footer-logo" className="w-[3.375rem] h-[3.375rem] md:w-auto md:h-[6.75rem]"/>
                    <div className="flex gap-[2.125rem] *:cursor-pointer items-center flex-wrap">
                        <a href="https://wa.me/5581996350832" target="_blank"><img src="/src/assets/img/footer/icons/whatsapp_icon.svg" alt="whatsapp-icon" className="hover:opacity-80 max-w-6 md:min-w-8"/></a>
                        <a href="mailto:contato@institutoliber.com"><img src="/src/assets/img/footer/icons/email_icon.svg" alt="email-icon" className="hover:opacity-80 max-w-6 md:min-w-8"/></a>
                        <a href="https://www.instagram.com/institutoliberdeperformance/" target="_blank"><img src="/src/assets/img/footer/icons/instagram_icon.svg" alt="instagram-icon" className="hover:opacity-80 max-w-6 md:min-w-8"/></a>
                        <a href="https://www.facebook.com/profile.php?id=61558696227050" target="_blank"><img src="/src/assets/img/footer/icons/facebook_icon.svg" alt="facebook-icon" className="hover:opacity-80 max-w-[0.875rem] md:min-w-4"/></a>
                        <a href="https://www.linkedin.com/company/instituto-de-performance-profissional-liber/" target="_blank"><img src="/src/assets/img/footer/icons/linkedin_icon.svg" alt="linkedin-icon" className="hover:opacity-80 max-w-6 md:min-w-8"/></a>
                    </div>
                </div>
