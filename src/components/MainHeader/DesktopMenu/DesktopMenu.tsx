...
export const DesktopMenu = () => {
    ...
    return(
        <nav className="md:flex hidden items-center gap-[2.875rem] mr-[6.25rem] text-[1.375rem]">
            ...
            <Link className="text-white rounded-[2.75rem] min-w-[11.5rem] max-h-[3.875rem] ml-3 bg-[linear-gradient(259.18deg,_#E8924A_6.97%,_#E97B19_34.07%,_#E97B19_68.27%,_#F6B049_94.23%)] px-[1.75rem] py-[0.875rem] hover:opacity-90" to="/aula">Aula Gratuita</Link>
        </nav>
    )
}