    ...
    return(
        <>
            ...
            <nav className="md:flex hidden items-center gap-[2.875rem] mr-[6.25rem] text-[1.375rem]">
                <Link className={`hover:opacity-80 ${active == "mainpage" ? "active-menu" : ""}`} to="/">Instituto Liber</Link>
                <Link className={`hover:opacity-80 ${active == "coursespage" ? "active-menu" : ""}`} to="/cursos">Cursos</Link>
